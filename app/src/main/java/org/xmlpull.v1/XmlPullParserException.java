...
public class XmlPullParserException extends Exception {
    ...
    public XmlPullParserException(String str, XmlPullParser xmlPullParser, Throwable th) {
        super((str == null ? XmlPullParser.NO_NAMESPACE : str + " ") + (xmlPullParser == null ? XmlPullParser.NO_NAMESPACE : "(position:" + xmlPullParser.getPositionDescription() + ") ") + (th == null ? XmlPullParser.NO_NAMESPACE : "caused by: " + th));
        this.row = -1;
        this.column = -1;
