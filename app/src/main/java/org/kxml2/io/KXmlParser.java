...
public class KXmlParser implements XmlPullParser {
    ...
    L_0x0010:
        r1 = r0;
    L_0x0011:
        r0 = r6.srcCount;	 Catch:{ Exception -> 0x0067 }
        r2 = 4;
        if (r0 >= r2) goto L_0x001c;
    L_0x0016:
        r2 = r7.read();	 Catch:{ Exception -> 0x0067 }
    ...
    L_0x002c:
        r0 = "UTF-16BE";
        r1 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r2 = 0;
        r3 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r4 = 2;
        r3 = r3[r4];	 Catch:{ Exception -> 0x0067 }
        r3 = r3 << 8;
        r4 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r5 = 3;
        r4 = r4[r5];	 Catch:{ Exception -> 0x0067 }
        r3 = r3 | r4;
        r3 = (char) r3;	 Catch:{ Exception -> 0x0067 }
        r1[r2] = r3;	 Catch:{ Exception -> 0x0067 }
        r1 = 1;
        r6.srcCount = r1;	 Catch:{ Exception -> 0x0067 }
    L_0x0044:
        if (r0 != 0) goto L_0x0048;
    L_0x0046:
        r0 = "UTF-8";
    L_0x0048:
        r1 = r6.srcCount;	 Catch:{ Exception -> 0x0067 }
        r2 = new java.io.InputStreamReader;	 Catch:{ Exception -> 0x0067 }
        r2.<init>(r7, r0);	 Catch:{ Exception -> 0x0067 }
        r6.setInput(r2);	 Catch:{ Exception -> 0x0067 }
        r6.encoding = r8;	 Catch:{ Exception -> 0x0067 }
        r6.srcCount = r1;	 Catch:{ Exception -> 0x0067 }
        return;
    L_0x0057:
        r0 = r1 << 8;
        r0 = r0 | r2;
        r1 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r3 = r6.srcCount;	 Catch:{ Exception -> 0x0067 }
        r4 = r3 + 1;
        r6.srcCount = r4;	 Catch:{ Exception -> 0x0067 }
        r2 = (char) r2;
        r1[r3] = r2;
        r1 = r0;
        goto L_0x0011;
    ...
    L_0x00bf:
        ...
        goto L_0x0044;
    L_0x00d4:
        r0 = r7.read();	 Catch:{ Exception -> 0x0067 }
        if (r0 == r5) goto L_0x0157;
    L_0x00da:
        r2 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r3 = r6.srcCount;	 Catch:{ Exception -> 0x0067 }
        r4 = r3 + 1;
        r6.srcCount = r4;	 Catch:{ Exception -> 0x0067 }
        r4 = (char) r0;
    ...
    L_0x00e9:
        r2 = new java.lang.String;	 Catch:{ Exception -> 0x0067 }
        r0 = r6.srcBuf;	 Catch:{ Exception -> 0x0067 }
        r3 = 0;
        r4 = r6.srcCount;	 Catch:{ Exception -> 0x0067 }
        r2.<init>(r0, r3, r4);	 Catch:{ Exception -> 0x0067 }
        r0 = "encoding";
        r0 = r2.indexOf(r0);	 Catch:{ Exception -> 0x0067 }
        if (r0 == r5) goto L_0x0157;
    L_0x00fb:
        r3 = r2.charAt(r0);	 Catch:{ Exception -> 0x0067 }
        r4 = 34;
    ...
    L_0x010e:
        r3 = r0 + 1;
        r0 = r2.charAt(r0);	 Catch:{ Exception -> 0x0067 }
        r0 = r2.indexOf(r0, r3);	 Catch:{ Exception -> 0x0067 }
        r0 = r2.substring(r3, r0);	 Catch:{ Exception -> 0x0067 }
        goto L_0x0025;
    L_0x011e:
        r2 = -65536; // 0xffffffffffff0000 float:NaN double:NaN;
        r2 = r2 & r1;
